...
<?php
    ...
    $cant_proveedores = $row["totalProveedores"];
     ...
     // TOTAL DE PRODUCTOS
     $totalProductos =" SELECT COUNT(*) AS totalProductos FROM productos ";
     $restulProductos = $conex -> query($totalProductos);
     $row = $restulProductos->fetch_assoc();
     $cant_productos = $row["totalProductos"];
     $conex->close();
        ...
        <div class="container aside">
            ...
            <div class="container asid">
                <ul class="nav mt-4">
                    ...
                    <li class="nav-item mt-3">
                        <a class="nav-link " href="./php/noticias.php">
                            ...
                            <div class="offcanvas-body">
                             ...
                             <div class="col-12 d-flex align-items-center ps-0">
                                ...
                                <div class="ps-4 menuBurger">
                                    ...
                                    <a class="nav-link mt-4" href="./php/proveedores.php">
                                    <i class="fa-solid fa-people-group"></i> Proveedores</a>
                                        
                                    <!-- <a class="nav-link mt-4" href="">
                                    <i class="fa-solid fa-box-open"></i> Pedidos</a> -->
                                        
                                    <a class="nav-link mt-4" href="./php/productos.php">
                                    <i class="fa-solid fa-apple-whole"></i> Productos</a>
                                            
                                    <a class="nav-link mt-4" href="./php/noticias.php">
                                    <i class="fa-solid fa-comment-dots"></i> Noticias</a>
                ...
                <div class="container-fliut w-100 pt-3 dash mb-3">
                    <div class="container cajas d-flex">
                        ...
                        <i class="fa-solid fa-apple-whole py-3"></i>
                            <p>Productos</p>
                            <p class="dasNum"><?php echo $cant_productos; ?></p> 
                        </div>
                        <!-- <div class="caja py-1">

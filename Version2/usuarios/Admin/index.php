            ...
            <div class="container asid">
                <ul class="nav mt-4">
                    ...
                    <li class="nav-item mt-2">
                        ...
                        <div class="dropdown">
                            <button class="btn dropdown-toggle mt-4 ps-4 border-outline-none" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="usuario">
                                    <div class="log">
                                        <img class="rounded-pill" src="../../img/ana.png" alt="">
                                        <br> <span>Ana trini</span> 
                                    </div>
                                </div>
                            </button>
                            <ul class="dropdown-menu" >
                                ...
                                <li><a class="dropdown-item text-dark" href="#">Cerrar Sesion</a></li>
                            </ul>
                    </div>
            </div>
        </div>
        ...
        <div class="cuerpo px-5">
                <div class="head d-flex h5 pt-2 px-3">
                    ...
                    <div class="">
                        ...
                        <button class="btn btnBurger" type="button" data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop" aria-controls="staticBackdrop">
                        ...
                        <div class="offcanvas offcanvas-start " data-bs-backdrop="static" tabindex="-1" id="staticBackdrop" aria-labelledby="staticBackdropLabel">
                            ...
                            <div class="offcanvas-body bg-secondary">
                                <div class="ps-3 menuBurger">

                                    <a class="nav-link mt-4" href="./php/empleados.php">
                                    <i class="fa-solid fa-users-line"></i> Empleados</a>
